...
- Currently working as a full stack developer at Info-Electronics HP System, Montreal, Quebec, Canada in ReactJS and Java Spring Boot microservices architecture building weather forecast web Applications using open layers and map server. 
...
- I have work experience in various framework Java Spring boot, ReactJS, C# Core Web API, Python Fast API, SQL server, Mongodb and Node.js, AngularJS, Angular 12+, Javascript, Python Flask API.
